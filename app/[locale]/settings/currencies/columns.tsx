...
export const getColumns = (
  ...
  {
    accessorKey: "name",
    header: t('settings:currencies.name'),
  },
  {
    accessorKey: "code",
    header: t('settings:currencies.code'),
  },
  {
    accessorKey: "symbol",
  ...
  },
  {
    ...
    header: t('settings:currencies.status'),
    cell: ({ row }) => {
      ...
      return isDefault ? (
        ...
        <Badge variant="secondary">{t('settings:currencies.secondary')}</Badge>
      )
    },
  },
  {
      ...
      return (
        <div className="flex items-center gap-2">
          {!isDefault && (
            ...
            >
              <Star className="h-3 w-3 mr-1" />
              {t('settings:currencies.setDefault')}
            </Button>
          )}
          {!isDefault && (
            <Button
