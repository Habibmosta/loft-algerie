      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto">
          <NewLoftFormWrapper
            ...
            translations={{
              loftCreatedSuccess: t('loftCreatedSuccess', { ns: 'lofts' }),
              loftCreatedSuccessDescription: t('loftCreatedSuccessDescription', { ns: 'lofts' }),
              errorCreatingLoft: t('errorCreatingLoft', { ns: 'lofts' }),
              errorCreatingLoftDescription: t('errorCreatingLoftDescription', { ns: 'lofts' }),
              systemError: t('systemError', { ns: 'lofts' }),
              systemErrorDescription: t('systemErrorDescription', { ns: 'lofts' }),
            }}
          />
        </div>
      </div>
